...
<div id="app">
    <div class="main-title">
        <label style="margin:0px;">Logistic Infotech Rating Component</label>
    </div>
        ...
        <div class="li-rating-wrapper">
            ...
            <div class="rating-holder">
                <div class="width-height-five">
                    <li-rating total-icons="8" v-bind:svg-icon-path="require('@/assets/smily.svg')" color="#00ADBF">
                    </li-rating>
                </div>
            </div>
        </div>
        ...
        <div class="li-rating-wrapper">
            ...
            <div class="rating-holder">
                <div class="width-height-six">
                    <li-rating v-bind:svg-icon-path="require('@/assets/grin-hearts.svg')" total-icons="9" color="rgb(249, 5, 20)">
                    </li-rating>
                </div>
            </div>
        </div>
...
export default {
  mounted() {
    var smileBeam = window.FontAwesome.icon({
      prefix: "fas",
      iconName: "smile-beam"
    }).html[0];
